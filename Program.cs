...
namespace Dubot
{
    ...
    class DubotConsole
    {
        ...
        public Task GuildMemberUpdatedAsync(SocketGuildUser arg1, SocketGuildUser arg2)
        {
        ...
        public async Task RegisterCommandsAsync()
        {
            ...
            var assembly = AppDomain.CurrentDomain.GetAssemblies().FirstOrDefault(x => x.FullName.Contains("Dubot"));
        ...
        private async Task HandleCommandAsync(SocketMessage arg)
        {
                ...
                message.HasMentionPrefix(_client.CurrentUser, ref argPos))
            {
                ...
                try
                {
                    ...
                    //First time command executed, it logs it into the database for wiki
                    //using (var dbContext = new DubaseContext())
                    //{
                    //    var cName = message.Content.Split(' ')[0].Replace("!", "");
                    //    var cmd = dbContext.BotCommands.FirstOrDefault(c => c.CommandName.Equals(cName, StringComparison.OrdinalIgnoreCase) ||
                    //                                                        c.BotCommandAlias.Any(x => x.Alias.Equals(cName, StringComparison.OrdinalIgnoreCase)));
                    //    if (cmd != null)
                    //    {
                    ...
                    //        });
                    //        DBValidateCheck(() => dbContext.SaveChanges());
                    //    }
                    //}
